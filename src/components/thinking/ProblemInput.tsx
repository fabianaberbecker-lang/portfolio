      ...
      <div className="w-full max-w-xl animate-fade-in-up">
        ...
        <div className="mt-10">
          <textarea
            ...
            rows={3}
            className="w-full resize-none rounded-xl border border-[var(--border-color)] bg-[var(--surface)] px-5 py-4 text-base text-[var(--foreground)] placeholder:text-[var(--muted)]/40 focus:border-[var(--accent)] focus:outline-none focus:ring-1 focus:ring-[var(--accent)]/30"
          />
          <button
