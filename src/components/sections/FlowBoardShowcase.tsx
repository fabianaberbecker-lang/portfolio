...
import { StickerBoard } from '@/components/decorative/StickerBoard';

export function FlowBoardShowcase() {
  const { t } = useLanguage();
  const sc = t.flowBoard.showcase;
      ...
      <Container className="max-w-6xl">
        ...
        <div className="mb-16 text-center">
          <Badge variant="accent" className="mb-4">
            <StickerBoard size={14} color="currentColor" className="mr-1 inline -mt-0.5" />
            {sc.title}
          </Badge>
        ...
        <div className="hidden items-center gap-16 lg:flex">
          <div className="shrink-0">
            <div className="relative">
              <PhoneMockup
                src="/apps/flowboard/app"
                title="FlowBoard preview"
              />
              <div className="absolute -inset-8 -z-10 rounded-[60px] bg-indigo-500/5 blur-3xl" />
            </div>
          </div>
