...
import { StickerCocktail } from '@/components/decorative/StickerCocktail';

export function BarMatchShowcase() {
  const { t } = useLanguage();
  const sc = t.barMatch.showcase;
      ...
      <Container className="max-w-6xl">
        ...
        <div className="mb-16 text-center">
          <Badge variant="accent" className="mb-4">
            <StickerCocktail size={14} color="currentColor" className="mr-1 inline -mt-0.5" />
            {sc.title}
          </Badge>
        ...
        <div className="hidden items-center gap-16 lg:flex">
          ...
          <div className="shrink-0">
            <div className="relative">
              <PhoneMockup
                src="/apps/barmatch/app"
                title="BarMatch preview"
              />
              {/* Decorative glow behind phone */}
              <div className="absolute -inset-8 -z-10 rounded-[60px] bg-pop-yellow/5 blur-3xl" />
            </div>
          </div>
        ...
        <div className="md:hidden">
          <div className="rounded-2xl border border-border bg-surface p-8 text-center">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-pop-yellow/10">
              <StickerCocktail size={28} />
            </div>
